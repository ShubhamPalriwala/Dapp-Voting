...
Decentralised App using BLockchain Server and Solidity Language.

Built a voting ballot application with 4 Fruits such that there is a chairperson who is authorized to register voters. Voters have the permission to vote only after the registration process.
